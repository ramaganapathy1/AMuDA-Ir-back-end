#Sample Command: python ml_audio/Naive_Bayes/ICMR_audio.py <TrainingDataSet> <test data>
#e.g.1 : python ml_audio/Naive-Bayes/ICMR_audio.py trainingData.tab CG1.txt
...
try:
    ...
    print "complete_file_path: " + complete_file_path
    inp="trainingdata"
    filepath=inp+"/"+trained_file_name
    print "trainloc : "+filepath
...
newdomain=orange.Domain([data.domain["tfidf"],  data.domain["cuewords"], data.domain["localspan"]], data.domain.classVar)
